"""
Smart Router — Ring 3: Routing & Load Balancing
(Formerly "Neural Router" — renamed because routing is rule-based/heuristic,
not neural-network based. No ML model is involved.)
...
# Lock protecting _rr_index from concurrent access.
